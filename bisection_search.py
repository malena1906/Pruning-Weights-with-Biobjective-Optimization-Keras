'''
 ...
 Description : Application of the bisection search algorithm on the Multi Adam optimizer (MAdam version 0.1) 
               ...
               case (for now only biobjective given). This is the main script for the bisection search 
               Pareto front plots. 
 ...
 Input(s)    : The MAdam Algorithm to solve the multiobjective optimization problem with two loss 
               ...
               Please note that for the bisection search the weighting of the loss functions remains constant over
               all training epochs (param multi=False) - there is no own calculation in the algorithm as suggested by
               S. Liu and L. N. Vicente. Only the bisection search algorihtm itself changes it. 
...
level=int(5) # choose depth of the search tree and first weighting of the objectives
...
for level in range(level):
    ...
    while i < len(candidates):
        ...
        l= (candidates[i]['lambda'] + candidates[i - 1]['lambda'])/2
